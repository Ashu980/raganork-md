...
module.exports = {
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '918984257480-1632403322@g.us',
    ...
    BOT_INFO: process.env.BOT_INFO || '𝛨𝛪𝛮𝛥𝑇𝛥;𝑆𝛩𝛨𝛥𝛮🐤;0;https://i.imgur.com/P7ziVhr.jpeg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "𝑆𝛩𝛨𝛥𝛮 🖤🖇️✨",
    BOT_NAME: process.env.BOT_NAME || '𝛨𝛪𝛮𝛥𝑇𝛥',
